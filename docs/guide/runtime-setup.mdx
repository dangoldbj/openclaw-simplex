...
Examples of plugin-side settings:
...
Examples of runtime-side startup flags:
...
These are examples worth considering when you run <code>simplex-chat</code> as an external service:
