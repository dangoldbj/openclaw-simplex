...
<Steps>
  ...
  <Step title="Policies are applied">
    OpenClaw evaluates DM policy, allowlists, group policy, pairing state, and command authorization. In pairing mode, newly discovered contacts must be approved before they become trusted senders.
  </Step>
