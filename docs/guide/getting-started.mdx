...
description: Go from a fresh install to the first invited SimpleX contact talking to your OpenClaw agent.
---
...
If you are upgrading from the pre-`1.0.0` `simplex` plugin/channel IDs, run the migration helper before switching your config and commands to `openclaw-simplex`:
