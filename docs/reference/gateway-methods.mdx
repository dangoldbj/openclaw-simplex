...
<Info>
  Manual user workflows are usually simpler in the <code>simplex-chat</code> console. Gateway methods are most useful for automation, agent integrations, or returning QR data URLs programmatically.
</Info>
